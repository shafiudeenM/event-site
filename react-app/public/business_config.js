// ═══════════════════════════════════════════════════════════════
//  EVOKE EVENT — BUSINESS CONFIGURATION
//  Edit this file OR use the Admin Panel (admin.html) to update.
//  The main website reads all content from this config object.
// ═══════════════════════════════════════════════════════════════
...
const BUSINESS_CONFIG = {
  ...
  excellence: {
    ...
    items: [
      { icon: "fas fa-video", text: "EXCLUSIVE VIDEO TOURS" },
      { icon: "fas fa-utensils", text: "MULTI-CUISINE CATERING" },
      { icon: "fas fa-music", text: "LIVE ENTERTAINMENT" },
      { icon: "fas fa-leaf", text: "ECO-FRIENDLY SETUPS" },
      { icon: "fas fa-camera", text: "PHOTOGRAPHY & FILMS" },
      { icon: "fas fa-hotel", text: "VENUE BOOKING" },
...
function saveConfig(config) {
  localStorage.setItem("evoke_business_config", JSON.stringify(config));
}
...
function getActiveConfig() {
  return loadConfig() || BUSINESS_CONFIG;
}

function resetConfig() {
  localStorage.removeItem("evoke_business_config");
}
